...
class Grid {
    ...
    defaultStatusMessage() {
        ...
        return 'Grid. <i>LMB</i>: Drag to select area, <i>SHIFT/CTRL+LMB</i>: Add/Subtract selection, <i>MMB</i>: Drag grid, <i>MW</i>: Zoom grid, <i>E</i>: Rename circuit, <i>0</i> - <i>9</i>: Set ' + netColor + ', ' + (hasParent ? '' : '<u>') + '<i>W</i>: Switch to parent simulation' + (hasParent ? '' : '</u>');
    }
