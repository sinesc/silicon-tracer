...
test("pull resistors drive undriven nets", () => {
    ...
    // Switch consts: d2=c2 (close), d1=c1 (close), d0=c0 (close).
    ...
    sim.setConstValue(c1, 1);
    sim.setConstValue(c2, 0);
    sim.simulate(5);
    ...
    sim.setConstValue(c1, 0);
    sim.setConstValue(c0, 1);
    sim.simulate(5);
